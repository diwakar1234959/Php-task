...
$user_plan_sql = "SELECT subscription FROM users WHERE username = '$username'";
$user_plan_result = mysqli_query($con, $user_plan_sql);

$current_plan = "";
if ($user_plan_row = mysqli_fetch_assoc($user_plan_result)) {
    $current_plan = $user_plan_row['subscription'];
}
?>
  ...
  <div class="plans">
    ...
    <div class="planItem__container">
      ...
      <input type="hidden" name="plan" value="Silver">
        ...
        <div class="price">₹<?php echo $row['price']; ?><span>for <?php echo $row['duration']; ?><span></div>
        ...
        <button type="submit" name="plan" value="<?php echo $row['package']; ?>" class="button" id="alertButton">Book</button>
        </form>
      </div>
