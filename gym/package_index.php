            ...
            echo '<table>';
                ...
                while($row = mysqli_fetch_assoc($result)){
                    echo "<tr>";
                        ...
                        echo "<td><a href='package_up.php?id=" . $row["id"] . "' class='edit'><i class='fa-solid fa-pen' style='color: black;'></i></a></td>";
                        echo "<td><a href='package_delete.php?id=" . $row["id"] . "' class='edit'><i class='fa-solid fa-trash' style='color: black;'></i></a></td>";
                        echo "</tr>";
                }
                echo"</tbody>";
            echo"</table>";
